...
test('can modify the value of a `let` variable even in the next block statement', () => {
  ...
  expect(releaseName).toBe(/* ENTER YOUR GUESS HERE */'ES2015')
})
...
test('cannot modify the value of a `const` variable', () => {
  function getReleaseName() {
    ...
    const releaseName = 'ES6' // If you call it ES2015, then change this to let or var  // If you call it ES6, then remove this reassignment
    return releaseName
  }
